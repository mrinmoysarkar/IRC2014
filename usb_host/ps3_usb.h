...
#define PS3_ADDR        1 //3
#define PS3_VID         0x054c  // Sony VID//0x0079          
#define PS3_PID         0x0268  // Batch Device//0x0006
#define PS3_CONFIGURATION 1 //1
#define PS3_IF          0
#define PS3_NUM_EP      3 //2
#define EP_MAXPKTSIZE   64 //8
#define EP_INTERRUPT    0x03 //0x03
#define EP_POLL         0x01 //0x0A
